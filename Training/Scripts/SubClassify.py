...
model.name = "yeet/alexSubdural,imgs=27k,bs=32,epochs=12,lr=0.0001,d0.4"
train(model, train_data, val_data, batch_size=32, num_epochs=12, learning_rate=0.0001, optim_param="sgd")
