...
model.name = "detect_alex3_sig, imgs=32k, bs=128, epoch=30, lr=0.0001" #87.3
...
train(model, train_data, val_data, batch_size=128, num_epochs=30, learning_rate=0.0001)
